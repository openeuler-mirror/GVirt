...
class ModelConfig:
    ...
    """Per-layer attention type (0=full, 1=linear) for hybrid models."""
    full_attention_interval: int = ...
    """Interval used to auto-generate layer_types when empty."""
...
class LayerAttnType(Enum):
    """Per-layer attention type for hybrid models."""
...
LayerAttnFull: LayerAttnType = ...
"""Alias for :attr:`LayerAttnType.LayerAttnFull`."""
LayerAttnLinear: LayerAttnType = ...
"""Alias for :attr:`LayerAttnType.LayerAttnLinear`."""
AttnMLA: AttnType = ...
