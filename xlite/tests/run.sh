...
function run_glm5_w8a8()
{
    ...
    torchrun --nproc_per_node="$_moe_ep_size" --nnodes=1 --node_rank=0 --master_addr=127.0.0.1 tests/generate.py --model glm5 --ckpt-path $models_base_path/$_ckpt_dir/ ${RUN_ARGS[@]}
    rm $test_config_path
}
